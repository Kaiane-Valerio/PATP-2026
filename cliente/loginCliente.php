...
<head>
    ...
    <style>
        * {
        ...
        .senha-box {
            position: relative;
            margin-bottom: 10px; /* Reduzido para aproximar o link de recuperar */
        }
        ...
        .esqueceu-senha-container a:hover {
            color: var(--primary);
...
<body>
    ...
    <div class="left">
        ...
        <p>Entre para acompanhar suas ordens de serviço e abrir novas solicitações.</p>
    </div>

    <div class="right">
        <div class="box">
            <h2>Entrar</h2>
            <p class="sub">Acesse sua área de atendimento.</p>
            ...
            <form method="POST">
                ...
                <div class="esqueceu-senha-container">
